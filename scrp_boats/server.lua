...
RegisterServerEvent('scrp:buyboat')
AddEventHandler( 'scrp:buyboat', function ( args )
...
RegisterServerEvent( 'scrp:dropboat' )
AddEventHandler( 'scrp:dropboat', function ( )
    ...
    if HasBoates[1] then
        ...
        TriggerClientEvent("scrp:spawnBoat", _src, boat)
    end
